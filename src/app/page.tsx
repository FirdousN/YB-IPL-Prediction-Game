        ...
        <>
            ...
            >
                ...
                <main className="flex flex-col items-center text-center max-w-5xl space-y-8 relative z-10 mt-16">
                    ...
                    <div
                        className={`w-full transition-all duration-1000 cubic-bezier(0.4, 0, 0.2, 1) overflow-hidden transform fixed inset-x-0 bottom-0 z-50 px-4 pb-4 ${showLive
                    ...
                    <div
                        className={`w-full transition-all duration-1000 cubic-bezier(0.4, 0, 0.2, 1) overflow-hidden transform fixed inset-x-0 bottom-0 z-50 px-4 pb-4 ${showPrizes ? "translate-y-0 opacity-100 pointer-events-auto" : "translate-y-full opacity-0 pointer-events-none"
                            }`}
                    >
                    ...
                    <div
                        className={`w-full transition-all duration-1000 cubic-bezier(0.4, 0, 0.2, 1) overflow-hidden transform fixed inset-x-0 bottom-0 z-50 px-4 pb-4 ${showLeaderboard ? "translate-y-0 opacity-100 pointer-events-auto" : "translate-y-full opacity-0 pointer-events-none"
                            }`}
                    >
