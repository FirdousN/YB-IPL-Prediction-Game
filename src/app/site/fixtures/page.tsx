        ...
        <div className="bg-black/50 p-1 rounded-2xl border border-white/5 flex">
          {['Fixtures', 'Results'].map((tab) => (
            <button
              ...
              className={`px-8 py-2 rounded-xl text-xs font-black tracking-[0.2em] uppercase transition-all duration-300 ${
                activeTab === tab 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredMatches.map(m => (
            <div key={m.id} className="group relative">
               ...
               <div className={`relative bg-gradient-to-br from-gray-900 via-gray-900 to-black border rounded-[2.5rem] p-8 shadow-2xl transition-all duration-500 overflow-hidden ${
                  m.matchEnded 
